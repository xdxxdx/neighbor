				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input  name="communityId" class="form-control"
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input  name="communityName" class="form-control"
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input  name="adminGuard" class="form-control"
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input  name="ownerGuard" class="form-control"

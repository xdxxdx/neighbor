...
<body class="hold-transition skin-purple sidebar-mini">
								...
								<div class="box">
									<div class="panel-body">
										<div class="col-lg-1 col-md-3 col-sm-4 col-xs-6"
											...
											<div class="input-group">
												<div class="input-group-btn">
													<button type="button" class="btn btn-sm">所属小区:${communityInfo.communityName}</button>
												</div>
											</div>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6"
											...
											<div class="input-group">
												<div class="input-group-btn">
													<button type="button" class="btn btn-sm">所属楼栋:${floor.floorCode}</button>
												</div>
											</div>
										</div>
										<div class="col-lg-4 col-md-3 col-sm-4 col-xs-6"
											...
											<div class="input-group">
												<div class="input-group-btn">
													<button type="button" class="btn btn-sm">房号</button>
												</div>
												<!-- /btn-group -->
										...
										<div class="col-lg-3 col-xs-4 col-js-3"
											...
											<button type="button" id="submit1" class="btn bg-purple btn-sm btn_add">
												<span class="glyphicon glyphicon-plus"></span> 新增
											</button>
											<button type="button" id="btn_search" class="btn btn-default btn-sm">
												<span class="glyphicon glyphicon-search"></span> 查询
											</button>
											<button type="button" id="btn_back" class="btn btn-default btn-sm">
	...
	<script src="./static/js/back/room/room.js"></script>

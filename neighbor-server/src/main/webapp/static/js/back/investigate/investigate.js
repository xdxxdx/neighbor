		...
		table.on('tool(xdx_filter)', function(obj) {
			...
			if (obj.event == 'detail') {
				...
				layer.confirm('真的删除行么', function(index) {
					$.ajax({
						type:'post',
						url:'./hidden?investigateId='+data.investigateId,
				...
				layui.use('layer', function() {
							...
							layer.open({
								...
								shade: 0.5,
								maxmin: true,
								content: './edit?investigateId='+data.investigateId
							});
						});
					...
					layui.use('layer', function() {
							...
							layer.open({
								...
								shade: 0.5,
								maxmin: true,
								content: './video?investigateId='+data.investigateId
							});
						});

...
strContent=DvbbsHtmlAn(strContent);
 ...
 strContent=strContent.replace(re,"<a href=$1 target=_blank><IMG SRC='$1' border=0 alt=点击在新窗口浏览图片 onload=\"javascript:if(this.width>screen.width-333)this.width=screen.width-333\" galleryImg=no></a>");

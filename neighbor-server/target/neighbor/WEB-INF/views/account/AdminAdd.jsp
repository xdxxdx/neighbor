			...
			<form class="form-horizontal" id="thisForm">
				...
				<div class="box-body">
					<div class="form-group">
						<label class="control-label label-layer-left" for="adminName">邮箱</label>
						<div class="div-layer-left">
							<input id="email" name="email" class="form-control"
								type="text" placeholder="请输入邮箱，用于登录">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label label-layer-left" for="trueName">密码</label>
						<div class="div-layer-left">
							<input id="true" name="password" class="form-control"
								type="password" placeholder="请输入密码"><div class="show-pwd">显示</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="div-layer-left">
							<select name="communityId" class="form-control" >
								...
								<option value="7763">陶然新村</option>
								<option value="7764">东篱新村</option>
								<option value="7765">陶然居</option>
							</select>
						</div>
					</div>
					<div class="form-group">

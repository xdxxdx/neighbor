			...
			<form class="form-horizontal" id="thisForm">
				...
				<div class="box-body">
						...
						<div class="div-layer-left">
							<select name="communityId" id="communityId" class="form-control" >
								<c:forEach items="${communityList}" var="community">
									<option value="${community.communityId}"<c:if test="${community.communityId==floor.communityId}">selected</c:if>>${community.communityName}</option>
								</c:forEach>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input name="floorCode" value="${floor.floorCode}" class="form-control"
					...
					<div class="form-group">
						...
						<div class="div-layer-left">
							<input  name="guardNo" value="${floor.guardNo}" class="form-control"

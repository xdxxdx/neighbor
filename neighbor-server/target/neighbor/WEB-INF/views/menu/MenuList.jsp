...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="./static/AdminLTE-2.4.2/dist/css/skins/skin-blue.css">
		<!--ztree-->
		<link href="./static/zTree/css/zTreeStyle/zTreeStyle.css" rel="stylesheet">
		<!--自定义css-->
		<link rel="stylesheet" href="./static/css/back/common.css">
		<link rel="stylesheet" href="./static/css/back/menu.css">
		<style>
			.ztree li a {
				color: #28a3ef;
				vertical-align: -5px;
	...
	<body class="hold-transition skin-purple sidebar-mini" >
									...
									<div class="box">
										<div class="panel-body">
											<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6" style="padding-bottom: 2px">
												<div class="input-group">
													<div class="input-group-btn">
														<button type="button" class="btn  btn-sm">菜单名称</button>
													</div>
													<!-- /btn-group -->
											...
											<div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" style="padding-bottom: 2px">
												<div class="input-group">
													<div class="input-group-btn">
														<button type="button" class="btn  btn-sm">菜单类型</button>
													</div>
													<!-- /btn-group -->
											...
											<span class="glyphicon glyphicon-search"></span> 查询
												...
												<button type="button" class="btn bg-blue btn-sm btn_add">
		...
		<script src="./static/js/xdx.js"></script>
		<script src="./static/js/back/common.js"></script>
		<script src="./static/js/back/menu/menu.js"></script>

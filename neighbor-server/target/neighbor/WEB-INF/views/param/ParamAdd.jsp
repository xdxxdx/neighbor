		...
		<form class="form-horizontal" id="thisForm">
			...
			<div class="box-body">
				<div class="form-group">
					<label class="control-label label-layer-left" for="adminName">门禁有效时间</label>
					<div class="div-layer-left">
						<input id="lockTime" name="lockTime" value="${param1.lockTime}" class="form-control"
							   type="number" placeholder="请输入门禁有效时间">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label label-layer-left" for="img">广告图</label>
					<div class="div-layer-left">
						<!--<input id="img" name="upload" class="form-control"
                               type="file" >-->
						<div class="img-box full">
							<section class=" img-section">
								<p class="up-p">图片：<span class="up-span">750*330,不超过500K</span></p>
				...
				<div class="form-group">
					<label class="control-label label-layer-left" for="img">海报图</label>
					<div class="div-layer-left">
						<!--<input id="img" name="upload" class="form-control"
                               type="file" >-->
						<div class="img-box full">
							<section class=" img-section">
								<p class="up-p">图片：<span class="up-span">900*1600,不超过500K</span></p>
								<div class="z_photo upimg-div clear" >
									<section class="z_file fl">
										<c:choose>
